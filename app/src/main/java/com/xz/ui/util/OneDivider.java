...
import com.xz.ui.R;
import com.xz.ui.fragment.one.OneAdapter;
...
public class OneDivider extends Y_DividerItemDecoration {
    ...
    public OneDivider(Context context, OneAdapter adapter) {
        super(context);
        mAdapter = adapter;
    ...
    public Y_Divider getDivider(int itemPosition) {
        switch (mAdapter.getItemViewType(itemPosition)) {
            ...
            case OneAdapter.ITEM_GRID_2:
                ...
                if (mAdapter.getItemViewType(itemPosition - 1) == OneAdapter.ITEM_TITLE) {
                    d2Tag = itemPosition;
                }
